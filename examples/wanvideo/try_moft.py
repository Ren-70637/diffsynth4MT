import torch
from diffsynth import ModelManager, WanMoftPipeline, save_video, VideoData
...
def main(args):
    ...
    pipe = WanMoftPipeline.from_model_manager(model_manager, torch_dtype=torch.bfloat16, device="cuda")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, default=None, choices=['No_transfer', 'AMF', 'effi_AMF', 'MOFT'],help="Mode for the video generation, e.g., 'No_transfer'")
