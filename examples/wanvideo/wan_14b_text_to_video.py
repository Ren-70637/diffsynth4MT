...
def main(args):
    ...
    model_manager.load_models(
        [
            [
                "/root/autodl-tmp/Wan-AI/Wan2.1-T2V-14B/diffusion_pytorch_model-00001-of-00006.safetensors",
                "/root/autodl-tmp/Wan-AI/Wan2.1-T2V-14B/diffusion_pytorch_model-00002-of-00006.safetensors",
                "/root/autodl-tmp/Wan-AI/Wan2.1-T2V-14B/diffusion_pytorch_model-00003-of-00006.safetensors",
                "/root/autodl-tmp/Wan-AI/Wan2.1-T2V-14B/diffusion_pytorch_model-00004-of-00006.safetensors",
                "/root/autodl-tmp/Wan-AI/Wan2.1-T2V-14B/diffusion_pytorch_model-00005-of-00006.safetensors",
                "/root/autodl-tmp/Wan-AI/Wan2.1-T2V-14B/diffusion_pytorch_model-00006-of-00006.safetensors",
            ],
            "/root/autodl-tmp/Wan-AI/Wan2.1-T2V-14B/models_t5_umt5-xxl-enc-bf16.pth",
            "/root/autodl-tmp/Wan-AI/Wan2.1-T2V-14B/Wan2.1_VAE.pth",
        ],
    ...
    video = VideoData("/root/autodl-tmp/diffsynth4MT/ref_videos/car_turn_41.mp4", height=480, width=832)
    # Text-to-video
    video = pipe(
